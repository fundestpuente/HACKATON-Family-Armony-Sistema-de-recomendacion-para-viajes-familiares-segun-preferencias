'''
ESTE CODIGO FUSIONA LOS DOS DATASETS BASE Y DEJA COMO RESULTADO EL ARCHIVO 'reseñas_con_atractivos_turisticos.csv'
CON UN TOTAL DE 1133 REGISTROS
'''
...
# Cargar datasets
# ------------------------------------------------------
df_atractivos = pd.read_csv('atractivos_tur.csv')
df_ratings = pd.read_csv('google_review_ratings.csv')
...
# ------------------------------------------------------
df_final.to_csv(
    'data/reseñas_con_atractivos_turisticos.csv',
    index=False,
    encoding='utf-8-sig',
    sep='|'
)
